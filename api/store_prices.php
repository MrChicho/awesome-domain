<?php
// Connect to your DB
$conn = new mysqli("127.0.0.1", "foicyrte_admin", "5A3NA4vTinX.HJL", "foicyrte_awesome-domain");
...
foreach ($cards as $card) {
  ...
  $stmt = $conn->prepare("INSERT INTO card_prices (scryfall_id, name, set_code, collector_number, usd_foil, usd) VALUES (?, ?, ?, ?, ?, ?)");
  $stmt->bind_param(
    "ssssdd",
    $data["id"],
    $data["name"],
