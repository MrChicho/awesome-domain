...
$historyStmt = $pdo->prepare("
    INSERT INTO price_history (scryfall_id, date, usd_foil, usd)
    VALUES (:id, CURDATE(), :usd_foil, :usd)
    ON DUPLICATE KEY UPDATE
        usd_foil = VALUES(usd_foil),
        usd = VALUES(usd)
");
...
$fetchStmt = $pdo->query("SELECT scryfall_id, usd_foil, usd FROM card_prices");
